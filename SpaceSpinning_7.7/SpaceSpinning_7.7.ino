...
void loop() {
  ...
  */
  if (millis() - tdata > 6000) {                                            //ogni minuto = 60000ms
    ...
    logdata(now, temperatura, umidita,inizio,portata,voltaggio);                                     //usa funzione ausiliaria logdata per incamerare data, temp,hum
  }
...
*/
void logdata(DateTime now, float t, float h, bool in, float Q, float v ) {                              //prendi le variabili di input
